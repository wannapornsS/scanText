...
class AdapterImageZoomInOut(private var callback :(Int) -> Unit) : RecyclerView.Adapter<AdapterImageZoomInOut.ViewHolderZoomInOut>(), View.OnTouchListener{
    class ViewHolderZoomInOut(v : View) : RecyclerView.ViewHolder(v)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderZoomInOut {
        binding = ItemImageBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        context = parent.context
        return ViewHolderZoomInOut(binding.root)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolderZoomInOut, position: Int) {
